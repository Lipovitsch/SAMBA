...
Original file is located at
    https://colab.research.google.com/drive/1ompM--_Rh8bX9WP0gCCCBS8d4j_6LBar
"""
...
class SAMBA(nn.Module):
    ...
    def gaussian_kernel_graph(self, E_A, x, gamma=1.0):
        ...
        x_time = torch.mm(x_mean.permute(1, 0), x_mean)  # noqa: F841
    ...
    def forward(self, input_ids):
        ...
        I = torch.eye(input_ids.size(2)).cuda()  # noqa: E741
...
class AVWGCN(nn.Module):
    ...
    def forward(self, x):
        ...
        I = torch.eye(self.inp).cuda()  # noqa: E741
...
class MambaBlock(nn.Module):
    ...
    def forward(self, x):
        ...
        gate = x * (1 - F.sigmoid(res))  # noqa: F841
